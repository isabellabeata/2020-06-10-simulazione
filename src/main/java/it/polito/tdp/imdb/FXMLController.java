...
public class FXMLController {
    ...
    void doAttoriSimili(ActionEvent event) {
    	...
    	if(a!=null) {
    		for(Actor ai: model.attoriSimili(a)) {
    			this.txtResult.appendText(ai.getLastName()+"\n");
    		}
    	}
    }
    ...
    void doCreaGrafo(ActionEvent event) {
    	...
    	if(gen!=null) {
    		...
    		this.txtResult.setText("Selezionare un genere prima di creare il grafo!");
    	}
    ...
    public void setModel(Model model) {
    	this.model = model;
    	this.boxGenere.getItems().addAll(this.model.popolaCmbGeneri());
    }
}
